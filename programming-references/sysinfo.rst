...
(major=0, minor=1, patch=0, git_delta=1, git_tag='0b532043',
...
``sysinfo.show_version()`` displays directly the version information on screen
...
``sysinfo.show_efuses()`` displays the eFuses information of the board. as in
